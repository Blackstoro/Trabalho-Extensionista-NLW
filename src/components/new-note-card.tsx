          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 bg-slate-900 py-4 txt-center text-sm text-slate-300 outline-none font-medium hover:text-slate-100"
              >
              ...
              <button 
                ...
                className="w-full bg-lime-400 py-4 txt-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500"
              >
                Salvar nota
              </button>
            )}
